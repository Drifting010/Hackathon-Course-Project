    ...
    return (
        <>
            <div className="container">
                ...
                <div className='bg_image'><img src="../public/01.png" alt="bg_img"/></div>
                <div className='basic'>
                    <h2>SIA App Challenge</h2>
